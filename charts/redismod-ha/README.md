...
|:--------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------|
| `image.repository`        | Redis image repository                 | `redismod/redismod`                                                                                  |
...
| `redis.modules.search.enabled`              | Enable RedisSearch Module                                                                                                                                                                          | `true`                                                                                     |
| `redis.modules.search.path`              | Path to RedisSearch Module                                                                                                                                                                          | `/usr/lib/redis/modules/redisearch.so`                                                                                     |
| `redis.modules.json.enabled`              | Enable ReJSON Module                                                                                                                                                                          | `true`                                                                                     |
| `redis.modules.json.path`              | Path to ReJSON Module                                                                                                                                                                          | `/usr/lib/redis/modules/rejson.so`                                                                                     |
| `redis.modules.graph.enabled`              | Enable RedisGraph Module                                                                                                                                                                          | `false`                                                                                     |
| `redis.modules.graph.path`              | Path to RedisGraph Module                                                                                                                                                                          | `/usr/lib/redis/modules/redisgraph.so`                                                                                     |
| `redis.modules.timeseries.enabled`              | Enable Redis TimeSeries Module                                                                                                                                                                          | `false`                                                                                     |
| `redis.modules.timeseries.path`              | Path to RedisSearch Module                                                                                                                                                                          | `/usr/lib/redis/modules/redistimeseries.so`                                                                                     |
| `redis.modules.bloom.enabled`              | Enable RedisBloom Module                                                                                                                                                                          | `false`                                                                                     |
| `redis.modules.bloom.path`              | Path to RedisBloom Module                                                                                                                                                                          | `/usr/lib/redis/modules/redisbloom.so`                                                                                     |
| `redis.modules.gears.enabled`              | Enable Redis Gears Module                                                                                                                                                                          | `false`                                                                                     |
| `redis.modules.gears.path`              | Path to Redis Gears Module                                                                                                                                                                          | `/usr/lib/redis/modules/redisgears.so`                                                                                     |
| `redis.modules.ai.enabled`              | Enable Redis AI Module                                                                                                                                                                          | `false`                                                                                     |
| `redis.modules.ai.path`              | Path to AI Module                                                                                                                                                                          | `/usr/lib/redis/modules/redisai.so`                                                                                     |
