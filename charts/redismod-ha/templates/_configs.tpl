...
{{- end }}
{{- end }}
{{- if .Values.redis.modules.search.enabled }}
    loadmodule {{ .Values.redis.modules.search.path }}
{{- end }}
{{- if .Values.redis.modules.json.enabled }}
    loadmodule {{ .Values.redis.modules.json.path }}
{{- end }}
{{- if .Values.redis.modules.graph.enabled }}
    loadmodule {{ .Values.redis.modules.graph.path }}
{{- end }}
{{- if .Values.redis.modules.timeseries.enabled }}
    loadmodule {{ .Values.redis.modules.timeseries.path }}
{{- end }}
{{- if .Values.redis.modules.bloom.enabled }}
    loadmodule {{ .Values.redis.modules.bloom.path }}
{{- end }}
{{- if .Values.redis.modules.gears.enabled }}
    loadmodule {{ .Values.redis.modules.gears.path }}
{{- end }}
{{- if .Values.redis.modules.ai.enabled }}
    loadmodule {{ .Values.redis.modules.ai.path }}
{{- end }}
{{- end }}
